######################ball######################
# baseline
python main.py --name ball --num_trajectories 1 --num_val_trajectories 1000 --lr 5e-3 --epochs 5000 --repeat 50 --J none  --R none  --G none --grad_H none --output-weight .25 --run_name ball_baseline_1 --experiment scaling --baseline
python main.py --name ball --num_trajectories 3 --num_val_trajectories 1000 --lr 5e-3 --epochs 1500 --repeat 20 --J none  --R none  --G none --grad_H none --output-weight .25 --run_name ball_baseline_3 --experiment scaling --baseline
python main.py --name ball --num_trajectories 10 --num_val_trajectories 1000 --lr 5e-3 --epochs 500 --repeat 10 --J none  --R none  --G none --grad_H none --output-weight .25 --run_name ball_baseline_10 --experiment scaling --baseline
python main.py --name ball --num_trajectories 30 --num_val_trajectories 1000 --lr 5e-3 --epochs 250 --repeat 5 --J none  --R none  --G none --grad_H none --output-weight .25 --run_name ball_baseline_30 --experiment scaling --baseline
python main.py --name ball --num_trajectories 100 --num_val_trajectories 1000 --lr 5e-3 --epochs 100 --repeat 1 --J none  --R none  --G none --grad_H none --output-weight .25 --run_name ball_baseline_100 --experiment scaling --baseline
python main.py --name ball --num_trajectories 300 --num_val_trajectories 1000 --lr 5e-3 --epochs 50 --repeat 1 --J none  --R none  --G none --grad_H none --output-weight .25 --run_name ball_baseline_300 --experiment scaling --baseline
...
python main.py --name spring --num_trajectories 30 --num_val_trajectories 1000 --lr 2e-3 --epochs 250 --repeat 5 --J default  --R default  --G mlp --output-weight .25 --run_name spring_default_30 --experiment scaling
