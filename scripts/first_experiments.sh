...
python main.py --name ball --num_trajectories 1000 --num_val_trajectories 1000 --lr 1e-3 --epochs 50 --repeat 5 --J matmul  --R matmul  --G mlp --output-weight .25 --run_name ball_matmul_matmul
python main.py --name ball --num_trajectories 10000 --num_val_trajectories 1000 --lr 5e-3 --epochs 50 --repeat 5 --J sigmoid  --R sigmoid  --G mlp --output-weight .25 --run_name ball_sigmoid_sigmoid
