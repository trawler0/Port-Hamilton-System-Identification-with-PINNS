bash scripts/scaling_motor.sh  # all
bash scripts/scaling_spring.sh  # all
bash scripts/scaling_ball.sh  # all
bash script_vs_kan.sh # motor
bash scripts/seed.sh # ball
