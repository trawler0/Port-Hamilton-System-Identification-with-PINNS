...
parser.add_argument("--name", type=str, default="spring_multi_mass")
parser.add_argument("--num_trajectories", type=int, default=100)
parser.add_argument("--num_val_trajectories", type=int, default=100)
parser.add_argument("--hidden_dim", type=int, default=32)
parser.add_argument("--depth", type=int, default=3)
parser.add_argument("--J", type=str, default="spring_chain")
parser.add_argument("--R", type=str, default="spring_chain")
parser.add_argument("--G", type=str, default="spring_chain")
parser.add_argument("--grad_H", type=str, default="spring_chain")
...
parser.add_argument("--no-forecast", action="store_true", default=False)

# 'mae_rel': 0.0022525445092469454
